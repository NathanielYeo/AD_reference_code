...
def original_one_nut():
    return[
        "original_one_m/metal_nut_1",
        "original_one_m/metal_nut_2",
        "original_one_m/metal_nut_3",
        "original_one_m/metal_nut_4",
        "original_one_m/metal_nut_5",
    ]

def original_one_screw():
    return[
        "original_one_s/screw_1",
        "original_one_s/screw_2",
        "original_one_s/screw_3",
        "original_one_s/screw_4",
        "original_one_s/screw_5",
    ]
...
def metal_nut_p():
        return[
        "pseudo_m/metal_nut_1",
        "pseudo_m/metal_nut_2",
        "pseudo_m/metal_nut_3",
        "pseudo_m/metal_nut_4",
        "pseudo_m/metal_nut_5",
    ]
